...
public class NuclearMedicineScanHandler extends AbstractHandler implements DiagnosticReportHandler {

	protected final Log log = LogFactory.getLog(this.getClass());

	public NuclearMedicineScanHandler() {
		super();
	}

	private static final String ServiceCategory = "NMS";
	...
	private DiagnosticReport getFHIRDiagnosticReport(Encounter omrsDiagnosticReport) {
		log.debug("NMS Handler : GetFHIRDiagnosticReport");
	...
	public DiagnosticReport saveFHIRDiagnosticReport(DiagnosticReport diagnosticReport) {
		log.debug("NMS Handler : SaveFHIRDiagnosticReport");
	...
	public DiagnosticReport updateFHIRDiagnosticReport(DiagnosticReport diagnosticReport, String theId) {
		log.debug("NMS Handler : UpdateFHIRDiagnosticReport");
	...
	public void retireFHIRDiagnosticReport(String id) {
		log.debug("NMS Handler : RetireFHIRDiagnosticReport");
		EncounterService encounterService = Context.getEncounterService();
